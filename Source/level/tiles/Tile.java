...
public abstract class Tile {
	...
	public static final Tile STONE = new BasicSolidTile(1, 1, 0, Colors.get(-1, 333, -1, -1), 0xff606060);
	public static final Tile GRASS = new BasicTile(2, 2, 0, Colors.get(-1, 131, 141, -1), 0xff00ff00);
	public static final Tile WATER = new AnimatedTile(3, new int[][]{{0,5},{1,5},{2,5},{1,5}}, Colors.get(-1, 004, 114, -1), 0xff0000ff, 750);
